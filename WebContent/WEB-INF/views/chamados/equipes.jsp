...
<div class="panel panel-primary">
        <div class="panel-heading"><h3 id="chamados"><center><strong>${equipe}</strong></center></h3></div>
							...
							<tbody>
								<c:forEach items="${chamadosEquipeAndamento}" var="chamadosEquipeAndamento">	
									<tr  class="${chamadosEquipeAndamento.alerta}">
										<td>${chamadosEquipeAndamento.statusDescricao}</td>
										<td><a href="http://suportecgti.dpf.gov.br/CAisd/pdmweb.exe?OP=SEARCH+FACTORY=cr+SKIPLIST=1+QBE.EQ.id=${chamadosEquipeAndamento.id}" target="_blank" >${chamadosEquipeAndamento.chamado}</a></td>
							...
							<tbody>
								<c:forEach items="${incidenteEquipeAndamento}" var="incidenteEquipeAndamento">	
									<tr  class="${incidenteEquipeAndamento.alerta}">
										<td>${incidenteEquipeAndamento.statusDescricao}</td>
										<td><a href="http://suportecgti.dpf.gov.br/CAisd/pdmweb.exe?OP=SEARCH+FACTORY=cr+SKIPLIST=1+QBE.EQ.id=${incidenteEquipeAndamento.id}" target="_blank" >${incidenteEquipeAndamento.chamado}</a></td>
							...
							<tbody>
								<c:forEach items="${chamadosEquipePendente}" var="chamadosEquipePendente">	
									<tr  class="${chamadosEquipePendente.alerta}">
										<td>${chamadosEquipePendente.statusDescricao}</td>
										<td><a href="http://suportecgti.dpf.gov.br/CAisd/pdmweb.exe?OP=SEARCH+FACTORY=cr+SKIPLIST=1+QBE.EQ.id=${chamadosEquipePendente.id}" target="_blank" >${chamadosEquipePendente.chamado}</a></td>									
							...
							<tbody>
								<c:forEach items="${incidenteEquipePendente}" var="incidenteEquipePendente">	
									<tr  class="${incidenteEquipePendente.alerta}">
										<td>${incidenteEquipePendente.statusDescricao}</td>
										<td><a href="http://suportecgti.dpf.gov.br/CAisd/pdmweb.exe?OP=SEARCH+FACTORY=cr+SKIPLIST=1+QBE.EQ.id=${incidenteEquipePendente.id}" target="_blank" >${incidenteEquipePendente.chamado}</a></td>										
